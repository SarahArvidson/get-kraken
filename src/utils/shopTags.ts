...
> = {
  hobbies: {
    base: "bg-indigo-100 dark:bg-indigo-900/40 text-indigo-800 dark:text-indigo-100 border-indigo-300 dark:border-indigo-600",
    active:
      "bg-indigo-500 dark:bg-indigo-500 text-white border-indigo-600 dark:border-indigo-400",
  },
  "social life": {
    base: "bg-cyan-100 dark:bg-cyan-900/40 text-cyan-800 dark:text-cyan-100 border-cyan-300 dark:border-cyan-600",
    active:
      "bg-cyan-500 dark:bg-cyan-500 text-white border-cyan-600 dark:border-cyan-400",
  },
  relationships: {
    base: "bg-pink-100 dark:bg-pink-900/40 text-pink-800 dark:text-pink-100 border-pink-300 dark:border-pink-600",
    active:
      "bg-pink-500 dark:bg-pink-500 text-white border-pink-600 dark:border-pink-400",
  },
  travel: {
    base: "bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-100 border-amber-300 dark:border-amber-600",
    active:
      "bg-amber-500 dark:bg-amber-500 text-white border-amber-600 dark:border-amber-400",
  },
  family: {
    base: "bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-100 border-emerald-300 dark:border-emerald-600",
    active:
