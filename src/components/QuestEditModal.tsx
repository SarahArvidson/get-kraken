  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[100] flex items-start justify-center p-1 sm:p-4 md:p-6 lg:p-8">
        <div
          className="!m-0 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-[calc(100%-0.5rem)] sm:w-full max-w-3xl max-h-[calc(100vh-7rem)] sm:max-h-[calc(100vh-9rem)] md:max-h-[calc(100vh-10rem)] lg:max-h-[calc(100vh-11rem)] flex flex-col relative z-[101] !mt-20 sm:!mt-32 md:!mt-36 lg:!mt-40 !mb-4 sm:!mb-0"
