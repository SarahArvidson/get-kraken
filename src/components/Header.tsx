            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-2 mb-1">
                <Link to="/" className="flex-1 min-w-0 hover:opacity-80 transition-opacity">
                  <h1 className="text-2xl sm:text-3xl font-bold text-left text-gray-900 dark:text-gray-100 leading-tight">
                    {APP_NAME}
                  </h1>
                  <p className="text-sm sm:text-base text-gray-500 dark:text-gray-200 mt-0.5">
                    {APP_SUBTITLE}
                  </p>
                </Link>
                <button
